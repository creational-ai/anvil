...
**Use existing diagrams** - Copy the `## Diagram` section from each task's results doc (`docs/[milestone-slug]-[task-slug]-results.md`). These are already generated by `/dev-diagram`.
...
1. **Gather** - Read all `docs/[milestone-slug]-*` files
...
7. **Write** - Output to `docs/[milestone-slug]-milestone-summary.md`
