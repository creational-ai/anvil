...
**Guide**: `~/.claude/skills/dev/references/milestone-details-guide.md`
**Template**: `~/.claude/skills/dev/assets/templates/milestone-details.md`

## Usage

```bash
# Create new milestone details doc
/milestone-details core

# Update existing doc with current progress
/milestone-details core update
```
