...
1. Read the guide: `~/.claude/skills/dev/references/lessons-guide.md`
2. Read the template: `~/.claude/skills/dev/assets/templates/lessons-learned.md`
...
1. Read the guide: `~/.claude/skills/dev/references/diagram-guide.md`
2. Read the template: `~/.claude/skills/dev/assets/templates/diagram.md`
