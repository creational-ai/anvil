...
Conduct market validation research using the market-researcher agent.
...
**Example**:
- `/spawn-market-researcher mission-control "Focus on: indie developer market, MCP server ecosystem"`
