---
description: Thorough market validation with Go/Pivot/Kill recommendation.
...
**Guide**: `~/.claude/skills/research/references/market-research-guide.md`
**Template**: `~/.claude/skills/research/assets/templates/market-research.md`
