...
- `~/.claude/skills/design/SKILL.md` - Design skill overview
- `~/.claude/skills/design/references/naming-research-guide.md` - Detailed process and evaluation criteria
- `~/.claude/skills/design/assets/templates/naming-research.md` - Output template
