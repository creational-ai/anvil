<!-- Empty overlay — inherits the skill baseline at ~/.claude/skills/session-agents/references/roles/custodian.md.
     ...
     Preview before launch:  comms compose custodian

     Example — delete the comment wrappers to activate:
       ## Responsibilities : base
       - Maintain this project's role roster + draft-folder convention in agents.md
       ## Boundaries
       - Never deploys or mutates skill source — drafts candidates and hands off to skillwright
-->
