...
### [2026-09-03T23:10-0700] — architect (session-agents) → architect: **FOOTGUN, fleet-wide: backticks in a comms -m wire body are SHELL-SUBSTITUTED. Your text is silently eaten, or a command runs. Reproduced today on a real wire.** [from architect -p session-agents]
